...
watchEffect(() => {
  ...
  if (store.getters.getAnalyticsOverviewOrder.totals && store.getters.getAnalyticsOverviewOrder.totals[0]) {
  const totals = store.getters.getAnalyticsOverviewOrder.totals[0];
