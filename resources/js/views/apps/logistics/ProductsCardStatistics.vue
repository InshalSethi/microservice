...
watchEffect(() => {
    ...
    if (store.getters.getProductsAnalytics.totals && store.getters.getProductsAnalytics.totals[0]) {
        const totals = store.getters.getProductsAnalytics.totals[0];

        logisticData.value[0].value = (totals.sales_amount !== null ? formatAmount(totals.sales_amount) : 0);
        logisticData.value[1].value = totals.total_orders !== null ? totals.total_orders : 0;
        logisticData.value[2].value = totals.products_sold !== null ? totals.products_sold : 0;
        logisticData.value[3].value = (totals.sales_amount !== null ? formatAmount(totals.sales_amount) : 0);
