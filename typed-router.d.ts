...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'admin-users-add-user': RouteRecordInfo<'admin-users-add-user', '/admin-users/AddUser', Record<never, never>, Record<never, never>>,
    'admin-users-admin-list': RouteRecordInfo<'admin-users-admin-list', '/admin-users/admin-list', Record<never, never>, Record<never, never>>,
    'admin-users-edit-user': RouteRecordInfo<'admin-users-edit-user', '/admin-users/EditUser', Record<never, never>, Record<never, never>>,
    'analytics-apexchart': RouteRecordInfo<'analytics-apexchart', '/analytics/apexchart', Record<never, never>, Record<never, never>>,
    'analytics-apexchart-order': RouteRecordInfo<'analytics-apexchart-order', '/analytics/apexchartOrder', Record<never, never>, Record<never, never>>,
    'analytics-dashboard-table': RouteRecordInfo<'analytics-dashboard-table', '/analytics/dashboardTable', Record<never, never>, Record<never, never>>,
    'analytics-orders': RouteRecordInfo<'analytics-orders', '/analytics/orders', Record<never, never>, Record<never, never>>,
    'analytics-order-table': RouteRecordInfo<'analytics-order-table', '/analytics/orderTable', Record<never, never>, Record<never, never>>,
    'analytics-overview': RouteRecordInfo<'analytics-overview', '/analytics/overview', Record<never, never>, Record<never, never>>,
    'analytics-overview-order': RouteRecordInfo<'analytics-overview-order', '/analytics/overview-order', Record<never, never>, Record<never, never>>,
    'analytics-products': RouteRecordInfo<'analytics-products', '/analytics/products', Record<never, never>, Record<never, never>>,
    'analytics-products-analytics-table': RouteRecordInfo<'analytics-products-analytics-table', '/analytics/ProductsAnalyticsTable', Record<never, never>, Record<never, never>>,
    ...
    'apps-ecommerce-order-add-order': RouteRecordInfo<'apps-ecommerce-order-add-order', '/apps/ecommerce/order/AddOrder', Record<never, never>, Record<never, never>>,
    ...
    'apps-ecommerce-order-list-add-order-note': RouteRecordInfo<'apps-ecommerce-order-list-add-order-note', '/apps/ecommerce/order/list/addOrderNote', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-add-prescrption': RouteRecordInfo<'apps-ecommerce-order-list-add-prescrption', '/apps/ecommerce/order/list/AddPrescrption', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-edit-order-note': RouteRecordInfo<'apps-ecommerce-order-list-edit-order-note', '/apps/ecommerce/order/list/EditOrderNote', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-edit-prescrption': RouteRecordInfo<'apps-ecommerce-order-list-edit-prescrption', '/apps/ecommerce/order/list/EditPrescrption', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-main-orders-detail-tabs': RouteRecordInfo<'apps-ecommerce-order-list-main-orders-detail-tabs', '/apps/ecommerce/order/list/main-orders-detail-tabs', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-order-list-edit': RouteRecordInfo<'apps-ecommerce-order-list-order-list-edit', '/apps/ecommerce/order/list/order-list-edit', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-order-detail-notes': RouteRecordInfo<'apps-ecommerce-order-list-order-detail-notes', '/apps/ecommerce/order/list/OrderDetailNotes', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-order-detail-precrption': RouteRecordInfo<'apps-ecommerce-order-list-order-detail-precrption', '/apps/ecommerce/order/list/OrderDetailPrecrption', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-orders-detail': RouteRecordInfo<'apps-ecommerce-order-list-orders-detail', '/apps/ecommerce/order/list/orders-detail', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-order-list-orders-list-new': RouteRecordInfo<'apps-ecommerce-order-list-orders-list-new', '/apps/ecommerce/order/list/orders-list-new', Record<never, never>, Record<never, never>>,
    ...
    'apps-logistics-logistics-card-statistics': RouteRecordInfo<'apps-logistics-logistics-card-statistics', '/apps/logistics/LogisticsCardStatistics', Record<never, never>, Record<never, never>>,
    ...
    'charts-chartjs-chart-js-line-chart': RouteRecordInfo<'charts-chartjs-chart-js-line-chart', '/charts/chartjs/ChartJsLineChart', Record<never, never>, Record<never, never>>,
    ...
    'products-add-product': RouteRecordInfo<'products-add-product', '/products/AddProduct', Record<never, never>, Record<never, never>>,
    'products-edit-product': RouteRecordInfo<'products-edit-product', '/products/EditProduct', Record<never, never>, Record<never, never>>,
    'products-product': RouteRecordInfo<'products-product', '/products/product', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'roles-add-role': RouteRecordInfo<'roles-add-role', '/roles/AddRole', Record<never, never>, Record<never, never>>,
    'roles-edit-role': RouteRecordInfo<'roles-edit-role', '/roles/EditRole', Record<never, never>, Record<never, never>>,
    ...
    'user-permission-add-user': RouteRecordInfo<'user-permission-add-user', '/user-permission/AddUser', Record<never, never>, Record<never, never>>,
    'user-permission-assign-permission': RouteRecordInfo<'user-permission-assign-permission', '/user-permission/assign-permission', Record<never, never>, Record<never, never>>,
    'user-permission-edit-user': RouteRecordInfo<'user-permission-edit-user', '/user-permission/EditUser', Record<never, never>, Record<never, never>>,
    'user-permission-folder-tree-item': RouteRecordInfo<'user-permission-folder-tree-item', '/user-permission/FolderTreeItem', Record<never, never>, Record<never, never>>,
    'user-permission-tree-item': RouteRecordInfo<'user-permission-tree-item', '/user-permission/TreeItem', Record<never, never>, Record<never, never>>,
